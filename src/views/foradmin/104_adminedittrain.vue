<template>
  ...
  <center>
    <div> <v-row>
        <v-col> <a href="/104D"><v-btn class="btn">delete</v-btn></a></v-col>
        <v-col> <a href="/104"><v-btn class="btn">add</v-btn></a></v-col>
  ...
  <div style="margin-top: 5%;">
    ...
    <v-sheet width="400" class="mx-auto sheet">
      ...
      <v-form @submit="form_submit" style="background-color: black; color: yellowgreen;">
        ...
        <v-select name="origin" v-model="origin" label=" Origin" :items="items" ></v-select> 
        <v-select  name="destination" v-model="destination" label=" Destination" :items="items" ></v-select>
        <v-text-field name="departure_time" v-model="departure_time" label="Departure Time"></v-text-field>
        <!-- <v-text-field name="type" v-model="type" label="Type"></v-text-field> -->
        <v-select name="type" v-model="type" :items="['Express', 'Local']" label="Type" required></v-select>
        <v-text-field name="arrival_time" v-model="arrival_time" label="Arrival Time"></v-text-field>
